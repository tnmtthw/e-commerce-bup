...
const Sidebar: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await fetchDataCount(); 
        setUserCount(data.userCount); 
        setCategoryCount(data.categroyCount); 
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link href="/admin/user">
                <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  {userCount !== null && (
                    <span className="inline-flex items-center justify-center w-3 h-3 p-3 text-xs font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">
                      {userCount}
                    </span>
                  )}
                </div>
            ...
            <li>
              <Link href="/admin/category">
                ...
                {categoryCount !== null && (
                  <span className="inline-flex items-center justify-center w-3 h-3 p-3 text-xs font-medium text-green-800 bg-green-100 rounded-full dark:bg-green-900 dark:text-green-300">
                    {categoryCount}
                  </span>
                    )}
                </div>
            ...
            <li>
              <Link href="/admin/product">
                <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  {productCount !== null && (
                  <span className="inline-flex items-center justify-center w-3 h-3 p-3 text-xs font-medium text-red-800 bg-red-100 rounded-full dark:bg-red-900 dark:text-red-300">
                    {productCount}
                  </span>
                  )}
                </div>
            ...
            <li>
              <Link href="/admin/order">
                <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  {orderCount !== null && (
                  <span className="inline-flex items-center justify-center w-3 h-3 p-3 text-xs font-medium text-yellow-800 bg-yellow-100 rounded-full dark:bg-yellow-900 dark:text-yellow-300">
                    {orderCount}
                  </span>
                  )}
                </div>
